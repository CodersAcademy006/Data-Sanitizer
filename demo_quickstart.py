...
from benchmark_generator import generate_csv_dataset
...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        generate_csv_dataset(num_rows=10_000, output_path=input_file, chunksize=5_000)  # Small dataset for quick demo
        ...
        pass1_stats = pass1_worker.process_file(input_path=input_file, chunksize=1000, sample_size=500)
        ...
        pass2_stats = pass2_worker.process_file(input_path=input_file, output_path=output_file, chunksize=1000)
