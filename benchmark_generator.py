        ...
        for chunk_start in range(0, num_rows, chunksize):
            ...
            for row_id in range(chunk_start, chunk_end):
                ...
                if random.random() < 0.05:
                    record["nested"] = {"level1": {"level2": f"value_{random.randint(1, 1000)}"}}
...
def main():
    ...
    parser.add_argument("--output-dir", default="./benchmark_datasets", help="Output directory for datasets")
