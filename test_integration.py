...
class TestPass1Worker:
    ...
    def test_pass1_with_csv(self, sample_csv_file, temp_dir):
        ...
        stats = worker.process_file(input_path=sample_csv_file, chunksize=5, sample_size=100)
    ...
    def test_pass1_with_jsonl(self, sample_jsonl_file):
        ...
        stats = worker.process_file(input_path=sample_jsonl_file, chunksize=5, sample_size=100)
...
class TestPass2Worker:
    ...
    def test_pass2_with_csv_to_csv(self, sample_csv_file, temp_dir):
        ...
        stats = worker.process_file(input_path=sample_csv_file, output_path=output_path, chunksize=5)
    ...
    def test_pass2_applies_imputations(self, sample_csv_file, temp_dir):
        ...
        schema_config = {"medians": {"id": 3.0}, "modes": {"email": "john@example.com"}}

        worker = Pass2Worker(storage_backend=None)
        stats = worker.process_file(
            input_path=sample_csv_file, output_path=output_path, chunksize=5, schema_config=schema_config
        )
...
class TestEndToEnd:
    ...
    def test_full_pipeline_csv_to_csv(self, sample_csv_file, temp_dir):
        ...
        pass1_stats = pass1_worker.process_file(input_path=sample_csv_file, chunksize=5, sample_size=100)
        ...
        pass2_stats = pass2_worker.process_file(input_path=sample_csv_file, output_path=output_path, chunksize=5)
    ...
    def test_full_pipeline_preserves_schema(self, sample_csv_file, temp_dir):
        ...
        pass2_worker = Pass2Worker(storage_backend=None)
        pass2_worker.process_file(input_path=sample_csv_file, output_path=output_path, chunksize=5)
...
class TestDataValidation:
    ...
    def test_pass2_handles_unsupported_format(self, temp_dir):
        ...
        stats = worker.process_file(input_path=txt_path, output_path=output_path)
...
class TestDeterminism:
    ...
    def test_pass2_deterministic(self, sample_csv_file, temp_dir):
        ...
        stats1 = worker1.process_file(input_path=sample_csv_file, output_path=output1, chunksize=5)
        stats2 = worker2.process_file(input_path=sample_csv_file, output_path=output2, chunksize=5)
